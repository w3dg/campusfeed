...
const ImageCard = ({ title, subtitle = "subtext", image, github }) => {
  return (
    <Card
      isPressable
      shadow="lg"
      classNames={{base:"bg-gradient-to-b from-slate-800 to-neutral-100 select-none group shrink-0 w-[160px] rounded-xl hover:scale-105 transform-all duration-200 ease-in-out h-full"}}
    >
      ...
      <CardFooter className="justify-between flex flex-row text-neutral-900 w-full h-full items-end">
